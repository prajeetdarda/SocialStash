...
const COL_A = DEMO_CARDS.slice(0, 3);
const COL_B = [...DEMO_CARDS.slice(1, 4)];
  ...
  return (
    <div className="relative min-h-screen bg-[#0c0e16] overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex items-start justify-center gap-5 opacity-35 -rotate-6 scale-110 pointer-events-none" aria-hidden="true">
        ...
        <MarqueeColumn cards={COL_A} direction="down" offset={-180} />
        <div className="hidden lg:block"><MarqueeColumn cards={COL_B} direction="up" offset={-50} /></div>
      </div>
      ...
      {/* Ambient glow */}
      <div className="absolute top-1/3 right-1/3 w-[400px] h-[400px] bg-indigo-600/15 rounded-full blur-[100px] animate-pulse-glow pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col items-center px-6 py-8">
        ...
        <p className="text-sm text-white/40 mb-6">Create your stash</p>
